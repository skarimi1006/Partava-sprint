...
// Ported from Partava-sprint — pure algorithm, no dependencies

var SHAMSI_DAYS = ['یکشنبه','دوشنبه','سه‌شنبه','چهارشنبه','پنجشنبه','جمعه','شنبه'];
var SHAMSI_MONTHS = ['فروردین','اردیبهشت','خرداد','تیر','مرداد','شهریور','مهر','آبان','آذر','دی','بهمن','اسفند'];
...
// Returns "شنبه — ۱۴۰۴/۰۱/۱۰"
function shamsiFullDate(date) {
  var d    = date || new Date();
  var day  = SHAMSI_DAYS[d.getDay()];
  var sdate = toShamsi(d);
  return day + ' — ' + sdate;
}
